...
function login(redirect_uri) {
  redirect_uri = location.origin + "/authorized.html?" + (0, _deparam.param)({
    redirect_uri: redirect_uri
  });
  window.open(_utterancesApi.UTTERANCES_API + "/authorize?" + (0, _deparam.param)({
    redirect_uri: redirect_uri
  }), '_top');
}
    ...
    return __awaiter(_this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 5:
            (0, _oauth.login)(_pageAttributes.pageAttributes.url);
            return [2];
        }
      });
    });
